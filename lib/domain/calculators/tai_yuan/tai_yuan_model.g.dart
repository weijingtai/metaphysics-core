...
part of 'tai_yuan_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TaiYuanModel _$TaiYuanModelFromJson(Map<String, dynamic> json) => TaiYuanModel(
  ...
  calculateStrategy: $enumDecode(
    _$TaiYuanCalculateStrategyEnumMap,
    json['calculateStrategy'],
  ),
  totalMatureMonth: (json['totalMatureMonth'] as num?)?.toDouble() ?? 0,
  isTestTubeBaby: json['isTestTubeBaby'] as bool? ?? false,
  adjustedTaiYuan: $enumDecodeNullable(_$JiaZiEnumMap, json['adjustedTaiYuan']),
...
Map<String, dynamic> _$TaiYuanModelToJson(TaiYuanModel instance) =>
    <String, dynamic>{
