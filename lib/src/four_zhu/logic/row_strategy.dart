...
abstract class HouseCalculator {
  ...
  static const HouseCalculator absent = _AbsentHouseCalculator();
}

class _AbsentHouseCalculator extends HouseCalculator {
  const _AbsentHouseCalculator();
...
abstract class _BaseHousePillarStrategy implements PillarComputationStrategy {
  const _BaseHousePillarStrategy([this._houseCalculator = HouseCalculator.absent]);

  final HouseCalculator _houseCalculator;
  ...
  Tuple2<TianGan, DiZhi>? _computeHouse({
    ...
    return isLifeHouse
        ? _houseCalculator.calculateLifeHouse(
            pillars: pillars,
            referenceDateTime: referenceDateTime,
          )
        : _houseCalculator.calculateBodyHouse(
            pillars: pillars,
            referenceDateTime: referenceDateTime,
          );
  }
...
class LifeHousePillarStrategy extends _BaseHousePillarStrategy {
  const LifeHousePillarStrategy([super.houseCalculator]);
...
class BodyHousePillarStrategy extends _BaseHousePillarStrategy {
  const BodyHousePillarStrategy([super.houseCalculator]);
