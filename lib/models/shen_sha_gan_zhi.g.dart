...
part of 'shen_sha_gan_zhi.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GanZhiShenSha _$GanZhiShenShaFromJson(
  ...
  (json['locationMapper'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(
      ...
      (e as List<dynamic>).map((e) => $enumDecode(_$JiaZiEnumMap, e)).toList(),
    ),
  ),
);

Map<String, dynamic> _$GanZhiShenShaToJson(
  GanZhiShenSha instance,
) => <String, dynamic>{
  'name': instance.name,
  'jiXiong': _$JiXiongEnumEnumMap[instance.jiXiong]!,
  'locationMapper': instance.locationMapper.map(
    (k, e) =>
        MapEntry(_$DiZhiEnumMap[k]!, e.map((e) => _$JiaZiEnumMap[e]!).toList()),
  ),
};
