...
part of 'basic_diviation_info.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DivinationPerson _$DivinationPersonFromJson(Map<String, dynamic> json) =>
    DivinationPerson(
      name: json['name'] as String?,
      gender: $enumDecode(_$GenderEnumMap, json['gender']),
      yearMingJiaZi: $enumDecode(_$JiaZiEnumMap, json['yearMingJiaZi']),
...
Map<String, dynamic> _$DivinationPersonToJson(DivinationPerson instance) =>
    <String, dynamic>{
      ...
      'yearMingJiaZi': _$JiaZiEnumMap[instance.yearMingJiaZi]!,
...
BasicDivination _$BasicDivinationFromJson(Map<String, dynamic> json) =>
    BasicDivination(
...
Map<String, dynamic> _$BasicDivinationToJson(BasicDivination instance) =>
    <String, dynamic>{
