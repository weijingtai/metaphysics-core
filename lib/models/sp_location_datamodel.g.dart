...
SPLocationDataModel _$SPLocationDataModelFromJson(Map<String, dynamic> json) =>
    SPLocationDataModel(
      appFeatureModule: $enumDecode(
        _$AppFeatureModuleEnumMap,
        json['appFeatureModule'],
      ),
...
const _$AppFeatureModuleEnumMap = {
  AppFeatureModule.bazi: 'bazi',
  AppFeatureModule.ziwei: 'ziwei',
  AppFeatureModule.qimen: 'qimen',
  AppFeatureModule.liuyao: 'liuyao',
  AppFeatureModule.none: 'none',
};
