...
int _monthOrderForHouse({
  ...
  final zhongQiAt = _findJieQiTimeNear(around: birthDateTime, target: zhongQi);
...
DateTime _findJieQiTimeNear({
  ...
  // In tyme, index 0 = 冬至, 1 = 小寒, 2 = 大寒, ..., 12 = 夏至, ..., 23 = 大雪.
  final termIndexMap = {
...
TianGan _shiftTianGan({required TianGan start, required int offset}) {
  const seq = <TianGan>[
    TianGan.JIA,
    TianGan.YI,
    TianGan.BING,
