...
import 'package:metaphysics_core/domain/calculators/four_zhu/strategies/hour_pillar_strategy.dart';
...
class HourFixedZiPingStrategy implements HourPillarStrategy {
  ...
  JiaZi _compose(TianGan gan, DiZhi zhi) {
    ...
    return JiaZi.listAll.firstWhere(
      (jz) => jz.tianGan == gan && jz.diZhi == zhi,
    );
  }
